...
UserModelDosen UserModelDosenFromJson(String str) => UserModelDosen.fromJson(json.decode(str));

String UserModelDosenToJson(UserModelDosen data) => json.encode(data.toJson());

class UserModelDosen {
  UserModelDosen({
    this.role,
    this.nip,
    this.nama,
  ...
  factory UserModelDosen.fromJson(Map<String, dynamic> json) => UserModelDosen(
    role: json["role"],
    nip: json["nip"],
    nama: json["nama"],
    namaLengkap:
