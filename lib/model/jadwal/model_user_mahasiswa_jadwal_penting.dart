...
class UserModelMahasiswaJadwalPenting {
  ...
  factory UserModelMahasiswaJadwalPenting.fromJson(String str) =>
      UserModelMahasiswaJadwalPenting.fromMap(json.decode(str));
