...
class RekapHasilStudiList extends StatelessWidget {
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('K', 40),
      _getTitleItemWidget('N', 40),
      _getTitleItemWidget('KxN', 40),
    ];
  }
  ...
  Widget _generateRightHandSideColumnRow(BuildContext context, int index) {
    return Row(
      children: <Widget>[
        Container(
          child: Text(transkrip![index].namaMk.toString(), style: TextStyle(fontSize: 12.0)),
          width: 200,
          height: 40,
        ...
        Container(
          child: Text(transkrip![index].sks.toString(), style: TextStyle(fontSize: 12.0)),
          width: 40,
          height: 40,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
        ...
        Container(
          child: Text(transkrip![index].nilai.toString(), style: TextStyle(fontSize: 12.0)),
          width: 40,
          height: 40,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
        ...
        Container(
          child: Text(transkrip![index].sksbobot.toString(), style: TextStyle(fontSize: 12.0)),
          width: 40,
          height: 40,
          padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
